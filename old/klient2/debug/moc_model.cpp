...
QT_MOC_LITERAL(7, 62, 10)
    ...
    "Model\0syg_rozm\0\0index\0msg_message\0"
    "text_message*\0msg_user_data\0user_data*"
};
...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->syg_rozm((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->msg_message((*reinterpret_cast< text_message*(*)>(_a[1]))); break;
        case 2: _t->msg_user_data((*reinterpret_cast< user_data*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Model::syg_rozm)) {
                *result = 0;
            }
        }
    }
